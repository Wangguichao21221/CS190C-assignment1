...
def run_scaled_dot_product_attention(
    ...
    return cs336_basics.utils.scaled_dot_product_attention(Q, K, V, mask)
...
def run_multihead_self_attention(
    ...
    """
    MHA = cs336_basics.utils.Multihead_Self_Attention(d_model=d_model, num_heads= num_heads)
    MHA.change_weights(q_proj_weight,k_proj_weight,v_proj_weight,o_proj_weight)
...
def run_cross_entropy(
    ...
    """
    cross_entropy = cs336_basics.utils.CrossEntropyLoss()
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    clipper = cs336_basics.utils.grad_clipper(max_l2_norm)
...
def get_adamw_cls() -> Any:
    ...
    """
    return cs336_basics.utils.AdamW_Optimizer
...
def run_get_lr_cosine_schedule(
    ...
    """
    scheduler = cs336_basics.utils.lr_cosine_scheduler()
    return scheduler.get_lr(it,max_learning_rate,min_learning_rate,warmup_iters,cosine_cycle_iters)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return cs336_basics.bpe.train_bpe(input_path,vocab_size,special_tokens,**kwargs)
